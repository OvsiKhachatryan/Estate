                            ...
                            <div class="my-favadd table-responsive userprof-tab">
                                <table class="table table-bordered table-hover mb-0 text-nowrap">
                                    ...
                                    <tr>
                                            ...
                                            <div class="media mt-0 mb-0">
                                                ...
                                                <div class="media-body">
                                                    <div class="card-item-desc ms-4 p-0 mt-2">
                                                        ...
                                                        <a href="javascript:void(0);"><i class="fa fa-clock-o me-1"></i> Nov-25-2019 , 16:54 pm</a><br>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="btn btn-info btn-sm text-white" data-bs-toggle="tooltip" data-bs-original-title="Delete from Wishlist"><i class="fa fa-trash"></i></a>
                                            <a href="javascript:void(0);" class="btn btn-primary btn-sm text-white" data-bs-toggle="tooltip" data-bs-original-title="Buy Now"><i class="fa fa-shopping-cart"></i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div class="media mt-0 mb-0">
                                                ...
                                                <div class="media-body">
                                                    <div class="card-item-desc ms-4 p-0 mt-2">
                                                        <a href="javascript:void(0);"><h4 class="font-weight-semibold">Villa</h4></a>
                                                        <a href="javascript:void(0);"><i class="fa fa-clock-o me-1"></i> Nov-22-2019 , 9:18 am</a><br>
                                                        <a href="javascript:void(0);"><i class="fa fa-tag me-1"></i> Sale</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media mt-0 mb-0">
                                                ...
                                                <div class="media-body">
                                                    <div class="card-item-desc ms-4 p-0 mt-2">
                                                        <a href="javascript:void(0);" class="tetx-dark"><h4 class="font-weight-semibold">Luxury Rooms</h4></a>
